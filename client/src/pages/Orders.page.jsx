...
function OrdersPage() {
    ...
    // ✅ DEBUG: Log the orders to verify structure
    useEffect(() => {
                                    ...
                                    <div className='flex gap-2 justify-between'>
                                        ...
                                        <div>
                                            {order?.orderStatus === "Ordered" &&
                                                <button className='bg-red-500 text-white px-2 py-1 rounded' onClick={() => handleCancel(order)}>
                                                    Cancel Order
                                                </button>}
                                        </div>
                                    </div>
                                    {order?.orderStatus === "Delivered" &&
                                        <button className="cursor-pointer text-blue-800 hover:underline" onClick={() => handleReviewModal(order)}>
                                            Write a Review
                                        </button>}
                                </div>
                            </div>
